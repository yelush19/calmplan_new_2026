...
export async function testProcessTree() {
  ...
  try {
    ...
    if (clients.length === 0) {
      ...
      const testNodes = ['P2_vat', 'P1_payroll', 'P1_payslip_sending', 'P1_social_security', 'P2_tax_advances'];
      ...
      let clientTree = {};
      console.log('\n  4a. Enable P1_payslip_sending (child) → should auto-enable P1_payroll (parent)');
      clientTree = toggleNode(clientTree, 'P1_payslip_sending', true, tree);
