...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "אשף מוכנות", href: createPageUrl("BatchSetup"), icon: Database },
      {
        name: "ניהול לקוחות",
        icon: Users,
        children: [
    ...
    <div dir="rtl" className="min-h-screen bg-background text-foreground">
      ...
      <div className="min-h-screen flex flex-col md:flex-row w-full">
        ...
        <main className="flex-1 flex flex-col min-h-0">
          ...
          <div className={`flex-1 ${isHomePage ? 'overflow-hidden' : 'overflow-auto p-3 md:p-6 lg:p-8'} bg-neutral-bg/30`}>
            <div className={isHomePage ? 'h-full' : 'max-w-full mx-auto'}>
              {children}
            </div>
          </div>
        </main>
