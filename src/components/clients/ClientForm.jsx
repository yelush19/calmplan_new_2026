      ...
      <Card className="shadow-xl">
        ...
        <CardContent>
          <Tabs defaultValue="basic" className="space-y-6">
            <TabsList className="grid grid-cols-4 md:grid-cols-7 gap-1 h-auto p-2 rounded-2xl border-2 border-gray-200 bg-gray-50">
              <TabsTrigger value="basic" className="data-[state=active]:bg-sky-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">פרטים בסיסיים</TabsTrigger>
              <TabsTrigger value="process_tree" className="data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">עץ תהליכים</TabsTrigger>
              <TabsTrigger value="financial" className="data-[state=active]:bg-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">כספי</TabsTrigger>
              <TabsTrigger value="providers" className="data-[state=active]:bg-violet-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">נותני שירותים</TabsTrigger>
              <TabsTrigger value="tax" className="data-[state=active]:bg-rose-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">מס</TabsTrigger>
              <TabsTrigger value="accounts" className="data-[state=active]:bg-cyan-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">בנק</TabsTrigger>
              <TabsTrigger value="integration" className="data-[state=active]:bg-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=inactive]:border-gray-200 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 rounded-xl px-3 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-200">אינטגרציות</TabsTrigger>
            </TabsList>
