        ...
        <CardContent>
          <Tabs defaultValue="basic" className="space-y-6">
            <TabsList className="flex flex-wrap gap-2 h-auto p-3 rounded-2xl bg-gradient-to-l from-gray-50 to-white border-2 border-gray-100 shadow-sm">
              ...
              <TabsTrigger value="tax" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-500 data-[state=active]:to-pink-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:scale-105 data-[state=inactive]:bg-white data-[state=inactive]:text-gray-600 data-[state=inactive]:border data-[state=inactive]:border-gray-200 data-[state=inactive]:hover:border-rose-300 data-[state=inactive]:hover:text-rose-600 rounded-full px-5 py-2.5 text-sm font-bold whitespace-nowrap transition-all duration-300">🧾 מס</TabsTrigger>
