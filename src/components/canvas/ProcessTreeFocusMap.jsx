...
const BRANCH_DNA = {
  ...
  P4: { color: '#FACC15', bg: '#FEF9C3', label: 'בית ואישי', emoji: '\uD83C\uDFE0' },
...
function matchTaskToNode(task, nodeMap) {
  ...
  const catMap = {
    ...
    'פנסיות — מתפעל': 'P1_operator', 'work_social_operator': 'P1_operator',
    'פנסיות — טמל': 'P1_taml', 'work_social_taml': 'P1_taml',
    'פנסיות וקרנות': 'P1_social_benefits',
