...
export const STATUS_CONFIG = {
  ...
  awaiting_recording:         { label: 'ממתין לרישום בהנה"ש',   bg: 'bg-sky-200',     text: 'text-sky-900',     border: 'border-sky-300',     priority: 4.5 },
...
export const TASK_STATUS_CONFIG = {
  ...
  awaiting_recording:         { text: 'ממתין לרישום בהנה"ש',   color: 'bg-sky-100 text-sky-800',         dot: 'bg-sky-500' },
